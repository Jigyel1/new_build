...
module ActivitiesSpecHelper
  def create_activities # rubocop:disable Metrics/SeliseMethodLength, Metrics/AbcSize
    ...
    create(:activity, owner: super_user, recipient: management, action: :status_updated, log_data: log_data)

    log_data = { owner_email: super_user.email, recipient_email: management.email }
    create(:activity, owner: super_user, recipient: management, action: :profile_deleted, log_data: log_data)
    ...
    create(:activity, owner: super_user, recipient: kam, action: :role_updated, log_data: log_data)

    log_data = { owner_email: super_user.email, recipient_email: kam.email }
    create(:activity, :tomorrow, owner: super_user, recipient: kam, action: :profile_updated, log_data: log_data)
  end
end
