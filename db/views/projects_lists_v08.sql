...
FROM projects
    ...
    LEFT JOIN telco_uam_users as kam_user ON telco_uam_users.id = projects.kam_assignee_id
    LEFT JOIN profiles ON profiles.user_id = telco_uam_users.id
    LEFT JOIN profiles as kam_profile ON kam_profile.user_id = kam_user.id
